...
function Faucet(props) {
  ...
  const [shouldDisplayComponent, setshouldDisplayComponent] = useState();
  ...
  async function loadComponent() {
    const claimedAlready = await coin_backend.getClaimListValue(Principal.fromText(props.userPrincipal));
  ...
  return (
    ...
    <div className="blue window">
      ...
      <label>Get your free coins here! Claim 100 JoshCoins to your address!
        ⬇️ 
        <br></br>
        <br></br>
